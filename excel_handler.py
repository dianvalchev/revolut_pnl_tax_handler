    ...
    def add_bgn_pnl_to_result_file(self, data):
        ...
        for sheet in wb.sheetnames:
            ...
            for row in range(2, ws.max_row + 1):
                ...
                # calculate and fill the PnL in BGN
            ...
            # write the total due amount at the end of the sheet (=SUM)
